...
extern "C" fn kernel_init(hart_id: u64, fdt_addr: u64) {
    ...
    */
                ...
                match cause {
                    ...
                    sbi::TvmCpuExitCode::SharedPageFault => {
                        ...
                        if fault_addr != SHARED_PAGES_START_ADDRESS {
                            println!("Fault in shared page region at {fault_addr:x}");
                            panic!("Unexpected shared page fault address");
                        }
    ...
    if guest_written_value != SHARED_PAGES_START_ADDRESS {
