...
[`PageTracker`]() is a system-side singleton that contains `Pages` and a list
...
a reference to `PageTracker` for checking which pages are assigned to it and
