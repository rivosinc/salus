...
use riscv_pages::{PageAddr, PageSize4k};
...
pub struct HwMemMap {
    ram_base: PageAddr<PageSize4k>,
    ram_size: u64,
    usable_ram_base: PageAddr<PageSize4k>,
}
...
impl HwMemMap {
    ...
    pub fn ram_base(&self) -> PageAddr<PageSize4k> {
        self.ram_base
    }
    ...
    pub fn usable_ram_base(&self) -> PageAddr<PageSize4k> {
