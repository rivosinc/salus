...
impl PageRange {
    ...
    pub(crate) unsafe fn new(start: PageAddr<PageSize4k>, end: PageAddr<PageSize4k>) -> Self {
        Self {
            next_page: start,
            end_page: end,
        }
    ...
    pub fn next_addr(&self) -> PageAddr<PageSize4k> {
        self.next_page
    }
